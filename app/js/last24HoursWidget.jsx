        ...
        if (index != 0 && index <= 24) {
          ...
          return <div className="one-plot" key={index}>
            <svg style={{ width: '100%', height: '100px'}}>
              ...
              <line x1={'-50%'} y1={y1Max} x2={'50%'} y2={y2Max} stroke={windColor[Math.round(max[index])]} strokeLinecap={'round'} strokeWidth={'2'} />;
              <line x1={'50%'} y1={y3Max} x2={'150%'} y2={y4Max} stroke={windColor[Math.round(max[index])]} strokeLinecap={'round'} strokeWidth={'2'} />;
              <line x1={'-50%'} y1={y1Avg} x2={'50%'} y2={y2Avg} stroke={windColor[Math.round(avg[index])]} strokeLinecap={'round'} strokeWidth={'2'} />;
              <line x1={'50%'} y1={y3Avg} x2={'150%'} y2={y4Avg} stroke={windColor[Math.round(avg[index])]} strokeLinecap={'round'} strokeWidth={'2'} />;
              <line x1={'-50%'} y1={y1Min} x2={'50%'} y2={y2Min} stroke={windColor[Math.round(min[index])]} strokeLinecap={'round'} strokeWidth={'2'} />;
              <line x1={'50%'} y1={y3Min} x2={'150%'} y2={y4Min} stroke={windColor[Math.round(min[index])]} strokeLinecap={'round'} strokeWidth={'2'} />;
            </svg>
