  ...
  render() {
    ...
    return <div className="widget" style={{ padding: '10px 0', background: 'rgba(255, 255, 255, 0.25)', color: 'black'}}>
      <div style={{ display: 'inline-block', width: '100%' }}>
        <button className="button" style={{ float: 'left', marginLeft: '10px'}} onClick={() => Actions.addBookmark(idStation)}><i className="fa fa-plus-circle" aria-hidden="true"/> favoris</button>
